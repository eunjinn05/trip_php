    ...
    <form class="needs-validation" method="POST">
      <div class="row g-3 ">
        ...
        <div class="col-12">
          ...
          <input type="password" class="form-control" id="password" name="mem_password">
        ...
        <div class="col-12">
          ...
          <input type="password" class="form-control" id="password_ck">
        ...
        <input type="hidden" name="mem_regdate">
        
      </div>

      <hr class="my-4">

      <button class="w-100 btn btn-primary btn-lg joinButton" type="button" data-action="/login/normal_join">회원가입</button>
    </form>
  </div>
</div>
